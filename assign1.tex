...
\begin {enumerate}
\item \begin {enumerate}
\item If $A = \myvec{1 & 2 & -3\\2 & 0 & -3\\1 & 2 & 0}$ then find $A^{-1}$ and hence solve the following system of equations :
        \begin {align*}
        x+2y-3z=1\\  2x-3z=2\\  x+2y=3
        \end {align*}
\item Find the product of the matrices $\myvec{1 & 2 & -3\\2 & 3 & 2\\3 & -3 & -4} \myvec{-6 & 17 & 13\\14 & 5 & -8\\-15 & 9 & -1}$ and hence solve the system of linear equations :
        \begin {align*}
...
\section {Integration}                                                             
\begin {enumerate}
\item \begin {enumerate}                   \item Find : $\int \cos^3x\, e^{log \sin x} dx$
...
of $0.8$ of paying in time next month and the customer who doesn't pay in time has the probability
 of $0.4$ of paying in time the next month.\\Based on the above information, answer the following questions:
 \begin {enumerate} 
 \item Let $E_1$ and $E_2$ respectively denote the event of customer paying or not paying the first month bill in time.\\ Find $P\brak{E_1}$, $P\brak{E_2}$.
 \item Let $A$ denotes the event of customer paying second month's bill in time, then find $P\brak{A|E_1}$ and $P\brak{A|E}$.
 \item Find the probability of customer paying second month's bill in time.
\item Find the probability of customer paying first month's bill in time if it is found that customer has paid the second month's bill in time.                                               \end {enumerate}
\end {enumerate}
...
\item \begin {enumerate}                                                                                               \item Students of a school are taken to a railway museum to learn about railway heritage and its history.                \begin {figure} [h!]
        \centering
...
\end {enumerate}
\item Let $S$ be the relation defined by
